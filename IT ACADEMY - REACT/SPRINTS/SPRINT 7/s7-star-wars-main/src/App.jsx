  ...
  return (
    <>
      <header className="flex flex-col justify-center">
        <div className="grid grid-cols-3 mx-20 my-4">
          <div>
            <div className="flex items-center gap-4">
              <a href="https://www.tiktok.com/@starwars?lang=es" className=' text-white transition-all duration-300 cursor-pointer hover:text-white hover:drop-shadow-[0_0_7px_rgba(255,255,255,0.7)] hover:font-medium' alt='Star Wars TikTok account' target='_blank'>
                <svg xmlns="http://www.w3.org/2000/svg" height="" width="21" viewBox="0 0 448 512">
                  <path fill="#ffffff" d="M448 209.9a210.1 210.1 0 0 1 -122.8-39.3V349.4A162.6 162.6 0 1 1 185 188.3V278.2a74.6 74.6 0 1 0 52.2 71.2V0l88 0a121.2 121.2 0 0 0 1.9 22.2h0A122.2 122.2 0 0 0 381 102.4a121.4 121.4 0 0 0 67 20.1z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/starwars/" className=' text-white transition-all duration-300 cursor-pointer hover:text-white hover:drop-shadow-[0_0_7px_rgba(255,255,255,0.7)] hover:font-medium' alt='Star Wars Instagram account' target='_blank'>
                <svg xmlns="http://www.w3.org/2000/svg" height="" width="21" viewBox="0 0 448 512">
              ...
              <a href="https://www.x.com/starwars/" className=' text-white transition-all duration-300 cursor-pointer hover:text-white hover:drop-shadow-[0_0_7px_rgba(255,255,255,0.7)] hover:font-medium' alt='Star Wars X (Twitter) account' target='_blank'>
                <svg xmlns="http://www.w3.org/2000/svg" height="" width="24" viewBox="0 0 512 512">
                  <path fill="#ffffff" d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/>
                </svg>
              </a>
              <a href="https://www.facebook.com/StarWars/" className=' text-white transition-all duration-300 cursor-pointer hover:text-white hover:drop-shadow-[0_0_7px_rgba(255,255,255,0.7)] hover:font-medium' alt='Star Wars Facebook account' target='_blank'>
                <svg xmlns="http://www.w3.org/2000/svg" height="" width="24" viewBox="0 0 512 512">
              ...
              <a href="https://www.youtube.com/StarWars/" className='border-r text-white transition-all duration-300 cursor-pointer hover:text-white hover:drop-shadow-[0_0_7px_rgba(255,255,255,0.7)] hover:font-medium' alt='Star Wars Youtube channel' target='_blank'>
              ...
              <a href="https://starwarskids.com/" className='text-white transition-all duration-300 cursor-pointer hover:text-white hover:drop-shadow-[0_0_7px_rgba(255,255,255,0.7)] hover:font-medium' alt='Star Wars Kids' target='_blank'>
          ...
          <div className="flex justify-center">
            <img src={starWarsLogo} width={200} alt="Star Wars Logo" />
          </div>

         
          <div className="flex justify-end h-fit">
            <ul className="flex divide-x-2">
              <li className="px-2 text-white transition-all duration-300 cursor-pointer hover:text-white hover:drop-shadow-[0_0_7px_rgba(255,255,255,0.7)] hover:font-medium">LOG IN</li>
              <li className="px-2 text-white transition-all duration-300 cursor-pointer hover:text-white hover:drop-shadow-[0_0_7px_rgba(255,255,255,0.7)] hover:font-medium">SIGN UP</li>
            </ul>
          </div>
        </div>
